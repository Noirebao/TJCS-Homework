...
class myUI(QtWidgets.QMainWindow):
    ...
    def init_ui_left(self):
        ...
        # 创建左侧中部的选择按钮
        self.leftButton1 = QtWidgets.QPushButton(qtawesome.icon('fa.home', color='#2c3a45'), "代码编辑")
        self.leftButton2 = QtWidgets.QPushButton(qtawesome.icon('fa.cog', color='#2c3a45'), "词法分析结果")
        self.leftButton3 = QtWidgets.QPushButton(qtawesome.icon('fa.envira', color='#2c3a45'), "语法分析结果")
        self.leftButton4 = QtWidgets.QPushButton(qtawesome.icon('fa.hourglass-start', color='#2c3a45'), "中间代码")
        self.leftButton5 = QtWidgets.QPushButton(qtawesome.icon('fa.heart', color='#2c3a45'), "函数表&符号表")
        self.leftButton6 = QtWidgets.QPushButton(qtawesome.icon('fa.tree', color='#2c3a45'), "目标代码")
        # 先设置这些按钮不可用
